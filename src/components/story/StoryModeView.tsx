...
export default function StoryModeView() {
  ...
  // TODO: This will be moved to the game store when we implement persistence
  const [completedChapters] = useState<string[]>([]);
  const [chapterProgress] = useState<Record<string, Record<string, number>>>({});
          ...
          {storyChapters.map((chapter) => {
            ...
            return (
              <div
                ...
                className={`bg-white/95 backdrop-blur-sm rounded-lg shadow-lg p-6 transition-all cursor-pointer ${
                  isLocked
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    {isAvailable && <div className="text-2xl">⭐</div>}
                  </div>
                </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {selectedChapter.objectives.map((objective) => {
                ...
                const completed = isChapterCompleted(selectedChapter.id) || objective.completed;
